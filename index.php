        ...
        <main>
            ...
            <div id="apropos">
                <section>
                    ...
                    <button type="button" class="d-block mx-auto btn btn-info">En savoir plus</button>
                    <p class="text-justify">Mon aventure de développeur commence au début de mon adolescence, en
                        faisant mes armes sur feu Le Site du Zéro où j ai approché le HTML/CSS
                        d époque, ainsi que le PHP procédural. J ai immédiatement accroché au
                        dialogue avec la machine informatique et j ai découvert un terrain de jeu
                        infini dont les seules limites étaient mon imagination.<br>
                        Plusieurs mods de jeux et expérimentations de musique électronique plus
                        tard, j ai rejoint Webforce3 en 2019 pour me former professionnellement au
                        métier de Développeur Web. Ici j ai rencontré des professeurs qui m ont
                        permis d asseoir mes connaissances, ainsi que de partager ma passion
                        avec des développeurs en herbe dont certains sont devenus par la suite des
